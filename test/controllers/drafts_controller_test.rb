...
class DraftsControllerTest < ActionController::TestCase
  ...
  test "should create draft" do
    assert_difference('Draft.count') do
      post :create, draft: { draft_team: @draft.draft_team, pick: @draft.pick, player_taken: @draft.player_taken, round: @draft.round }
    end
  ...
  test "should update draft" do
    patch :update, id: @draft, draft: { draft_team: @draft.draft_team, pick: @draft.pick, player_taken: @draft.player_taken, round: @draft.round }
    assert_redirected_to draft_path(assigns(:draft))
  end
